...
def test_resnet(device, dataset, checkpoint):
  """
  Computes accuracy and Cohen's kappa for a specified dataset
  ...
  config = XRAYconfig() # loads xray configuration
  ...
  with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
    ...
    try:
      ...
      while not coord.should_stop():
        ...
        # organizing predictions by study name
  ...
  # averaging accuracy and cohen kappa over study
